...
function Goals() {
  ...
  // Keyed by goal_id. Predictions are a separate call rather than part of the
  // user payload: they need the model loaded and a per-goal feature build, so
  // they must not delay or break the page if the model is unavailable.
  ...
  useEffect(() => {
    ...
    getGoalPredictions()
      ...
      .catch(() => {
        // Non-fatal: goals still render, just without a likelihood.
